package com.axis.input;

import java.util.InputMismatchException;
import java.util.Scanner;

import com.axis.customeException.InputMisMatchException;
import com.axis.customeException.InvalidInputException;
...
public class CartDataInput {
    ...
    public int askForId(String msg) {
        ...
        if (id <= 0)
            throw new InvalidInputException("❌ Id " + id + " is invalid. Please provide positive id");
        return id;
    }
