...
import com.shivu.spring.config.AppConfig;
import com.shivu.spring.util.FileChecker;
import com.shivu.spring.util.FileUtil;
...
public final class App {
    ...
    // AnnotationConfigApplicationContext(XlConfig.class, AppConfig.class);
